...
- 静的サイトジェネレーターについては [Astro](https://astro.build/) を推奨する（Astro プロジェクトの場合、GitHub テンプレートとして用意してある [burnworks-astro-starter](https://github.com/burnworks/burnworks-astro-starter) を使用してもよい）。
